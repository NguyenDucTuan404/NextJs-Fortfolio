    ...
    >
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
          <motion.a href="https://x.com/Teanneeeeee" target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
          >
          ...
          <motion.a href="https://github.com/NguyenDucTuan404" target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          >
          ...
          <motion.a href="https://www.linkedin.com/in/tuancutedapxetrenph0/" target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a href="https://www.pinterest.com/tuancutedapxetrenpho/" target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          >
          ...
          <motion.a href="https://dribbble.com/tuancutedapxetrenpho" target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 ml-3"
          >
...

      {
        isOpen ?
          <motion.div
            ...
            className='min-w-[70vw] flex flex-col justify-between items-center z-30 py-32 rounded-lg backdrop-blur-md
